...
**Defer:** *(closed — see Per-party markup override below)* · preset libraries on individual quote lines only.
...
**Defer:** preset libraries on individual quote lines only; per-line party markup stamp on sent quotes.
