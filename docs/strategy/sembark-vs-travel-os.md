...
**Defer:** *(closed — see Per-line markup presets below)* · per-line party markup stamp on sent quotes.
...
**Defer:** per-line party markup stamp on sent quotes.
