...
function SheetHeader({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      className={cn(
        'flex flex-col gap-1.5 border-b border-white/40 p-5 pr-12 dark:border-white/10',
        className,
      )}
      {...props}
    />
...
function SheetFooter({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      className={cn(
        'mt-auto flex flex-col-reverse gap-2 border-t border-white/40 p-5 sm:flex-row sm:justify-end dark:border-white/10',
        className,
      )}
      {...props}
    />
