...
export const PERMISSION_DEFS = [
  ...
  def(
    ...
    'approval',
    'Override customer credit limit on receivables',
    AGENCY,
    'high',
  ),
  def(
    'inventory_risk.approve',
    'approval',
    'Acknowledge allotment / capacity shortfall on quote send',
    AGENCY,
    'high',
  ),
  def(
    'rate_drift.approve',
    'approval',
    'Acknowledge rate-chart drift and keep prior buy on quote send',
    AGENCY,
    'high',
  ),
  def(
